...
{
    public function index(Request $request,IntegralOrder $integral_order_model){
    ...
    public function info(Request $request,IntegralOrder $integral_order_model){
        $id = $request->id;
    ...
    // 发货物流填写
    public function send_delivery(Request $request,IntegralOrder $integral_order_model){
