...
{
    // 获取好友列表信息
    public function get_chat_friend(Request $request,ChatFriend $chat_friend_model,ChatMsg $chat_msg_model){
        $user_info = auth()->user();
    ...
    // 添加好友
    public function add_friend(Request $request,ChatFriend $chat_friend_model){
        $friend_id = $request->firend_id;
        $user_info = auth()->user();
    ...
    // 获取聊天信息
    public function get_chat_msg(Request $request,ChatMsg $chat_msg_model){
        $user_info = auth()->user();
        $to_user_id = $request->to_user_id; // 聊天对象ID
    ...
    // 修改聊天信息为已读
    public function read_msg(Request $request,ChatMsg $chat_msg_model){
        $user_info = auth()->user();
        $to_user_id = $request->to_user_id; // 聊天对象ID
