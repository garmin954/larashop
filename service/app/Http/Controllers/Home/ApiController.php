...
{
    // 获取协议信息
    public function get_agreement_info(Request $request,Agreement $agreement_model){
        $ename = $request->ename;
    ...
    // 获取广告或者幻灯片
    public function get_banner(Request $request,AdvPosition $adv_position_model){
        $data = $adv_position_model->get_adv_list($request->name); // 获取幻灯片
