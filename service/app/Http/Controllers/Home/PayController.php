...
class PayController extends BaseController
{
    ...
    public function pay(Request $request,Config $config_model,Order $order_model,Helper $helperObj){

        $payment_name = $request->payment_name??'';  // 获取支付方式
    ...
    //  验证二维码支付是否正确
    public function check_wxpay_native(Request $request,Config $config_model){
