...
{
    // 获取提现列表
    public function get_cash_log(Request $request,CashLog $cash_log_model){
        $user_info = auth()->user();
    ...
    // 添加提现记录
    public function add_cash(Request $request,CashLog $cash_log_model,UserCkeck $user_check_model,Config $config_model,Users $user_model){
