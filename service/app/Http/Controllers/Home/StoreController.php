...
{
    // 获取商家信息
    public function get_store_info(Request $request,Store $store_model){
    ...
    // 获取商家首页信息
    public function get_store_index_info(Request $request,StoreGoodsClass $store_goods_class_model,Goods $goods_model){
        $user_id = $request->user_id;
    ...
    // 获取商家自定义栏目
    public function get_store_class(Request $request,StoreGoodsClass $store_goods_class_model){
        $user_id = $request->user_id;
    ...
    // 获取商家自定义栏目商品
    public function get_store_class_goods(Request $request,StoreGoodsClass $store_goods_class_model,Goods $goods_model){
        $user_id = $request->user_id;
