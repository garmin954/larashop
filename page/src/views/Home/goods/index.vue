    ...
    <div class="goods_index">
        ...
        <div class="goods_where width_center_1200">
            ...
            <div class="goods_cat_list">
                ...
                <ul>
                    <li :class="info.goods_brand==0?'font_color':''" @click="brand_change(0)">全部</li>
                    <li v-for="(v,k) in brand_list" :key="k" @click="brand_change(v.id)" :class="info.goods_brand==v.id?'font_color':''">{{v.name}}</li>
                </ul>
            </div>
            <div class="goods_cat_list">
        ...
        get_search_where:function(){
            ...
            paramsArr.forEach(res=>{
                ...
                if(paramsInfo[0] == 'brand_id'){
                    if(paramsInfo.length==2){
                        this.info.goods_brand = paramsInfo[1];
                    }else{
                        this.info.brand_id = 0;
                    }
                }
